...
public final class Constants {
  ...
  public static final class CAN {
    ...
    public static final int frontLeftCanCoder = 5;
    ...
    public static final int frontLeftDriveMotor = 9;
    ...
    public static final int backLeftTurnMotor = 1;
    public static final int backRightDriveMotor = 12;
    public static final int backRightTurnMotor = 10;
  }
